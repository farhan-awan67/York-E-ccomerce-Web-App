...
const Collection = () => {
  ...
  const handelSort = () => {
    let prdtCopy = filterProducts.slice();
    switch (productSort) {
      case "low-high":
        setFilterProducts(prdtCopy.sort((a, b) => a.price - b.price));
        break;

      case "high-low":
        setFilterProducts(prdtCopy.sort((a, b) => b.price - a.price));
        break;
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        ...
        >
          FILTERS
          <img className="h-3 sm:hidden " src="=" alt="" />
        </p>
        {/* category filter */}
        <div
